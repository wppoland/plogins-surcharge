...
final class ProUpsell
{
    ...
    {
        $default = (string) ($this->data()['url'] ?? 'https://plogins.com/plogins-surcharge-pro/pricing/');
        /**
         * Filters the URL the "Upgrade to PRO" buttons point at.
         *
         * @param string $url Default the Surcharge PRO pricing page.
         */
    ...
    private function priceLabel(): string
    {
        ...
        if ($this->isPolish() && ! empty($d['price_pln'])) {
            ...
            return sprintf(__('od %d zł/rok', 'plogins-surcharge'), (int) $d['price_pln']);
        }
    ...
    public function banner(): void
    {
        ...
        <div class="surcharge-pro-banner" role="note">
            ...
            <a class="button button-primary surcharge-pro-banner__cta" href="<?php echo esc_url($this->url()); ?>" target="_blank" rel="noopener noreferrer">
                <?php esc_html_e('Upgrade to PRO', 'plogins-surcharge'); ?>
            </a>
    ...
    public function aside(): void
    {
        ...
        <aside class="surcharge-pro-aside" aria-labelledby="surcharge-pro-aside-h">
            ...
            <?php if ($price !== '') : ?>
                <p class="surcharge-pro-aside__price"><?php echo esc_html($price); ?> · <?php esc_html_e('one licence, every PRO feature', 'plogins-surcharge'); ?></p>
            <?php endif; ?>
        </aside>
        <?php
    }
